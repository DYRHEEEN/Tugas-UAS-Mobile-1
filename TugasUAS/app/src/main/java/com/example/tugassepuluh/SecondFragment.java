...
public class SecondFragment extends Fragment {
    ...
    private static final String YOUTUBE_VIDEO_ID_1 = "qcGMKd8iego";
    private static final String YOUTUBE_VIDEO_ID_2 = "GMi-DDJtExs";
    private static final String YOUTUBE_VIDEO_ID_3 = "VvMAxmAapYA";
    private static final String YOUTUBE_VIDEO_ID_4 = "-cT495xKvvs";
